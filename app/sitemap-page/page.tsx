            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {sections.map((section) => (
                <div key={section.title}>
                  <h2 className="mb-4 text-xs font-bold uppercase tracking-widest text-[#e2a128]">{section.title}</h2>
                      ...
                      <li key={link.label}>
                        {"external" in link && link.external ? (
                          <a
                            ...
                            className="flex items-center gap-2 text-sm text-light-body hover:text-[#e2a128] transition-colors"
                          >
                            <span className="text-[rgba(226,161,40,0.40)]">›</span>
                            {link.label}
