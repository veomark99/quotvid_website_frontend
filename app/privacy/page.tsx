...
const sections = [
  ...
  { title: "12. User-Sourced Video Content", content: `QuotVid allows paid users to provide URLs to third-party video platforms (such as YouTube, TikTok, Instagram, or Vimeo) for use as video backgrounds. By submitting a URL, you represent that:\n- You have the right to use the referenced video content for your purposes\n- You have complied with the terms of service of the originating platform\n- The content does not infringe on any third-party intellectual property rights\n\nQuotVid processes and stores a short clip of the referenced video (up to 60 seconds) on Cloudflare R2 solely for the purpose of rendering your background. We do not distribute, resell, or make this content publicly accessible beyond your own generated videos.\n\nWe do not proactively monitor or review user-submitted video URLs. If you believe content has been submitted in violation of copyright or platform terms, contact us at hello@quotvid.com and we will remove it promptly.` },
];
