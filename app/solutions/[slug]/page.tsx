      ...
      <main>
        <section className="bg-section-dark pt-28 pb-12 sm:pt-32 sm:pb-16 md:pt-40 md:pb-20">
          <div className="container mx-auto max-w-3xl px-3 sm:px-4 md:px-8">
            <p className="mb-4 text-xs font-medium uppercase tracking-wider text-primary">Solutions</p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="inline-flex justify-center rounded-xl bg-gradient-gold px-6 py-3 text-sm font-bold text-primary-foreground transition-transform hover:scale-105"
              >
                Start free — no card
              </a>
              <Link
                href="/features"
                className="inline-flex justify-center rounded-xl border border-primary/30 px-6 py-3 text-sm font-semibold text-foreground transition-colors hover:bg-primary/10"
              >
                See all features
              </Link>
            </div>
        ...
        <section className="bg-section-light py-14 sm:py-20 border-t border-primary/10">
          <div className="container mx-auto max-w-3xl px-3 sm:px-4 md:px-8">
            ...
            <ul className="space-y-3 text-sm text-light-body">
              ...
              {others.map((o) => (
                <li key={o.slug}>
                  <Link href={solutionPath(o.slug)} className="text-primary hover:underline">
                    {o.h1}
                  </Link>
                </li>
              ))}
        ...
        <section className="bg-section-dark py-14 sm:py-20">
          <div className="container mx-auto max-w-xl px-3 text-center">
            ...
            <a
              href={`${APP_URL}/auth/signup`}
              className="inline-block rounded-xl bg-gradient-gold px-8 py-3 text-sm font-bold text-primary-foreground transition-transform hover:scale-105"
            >
