...
const faqs = [
  ...
  { q: "Is there a free trial?", a: "Yes — depending on how you sign up you can get a 5-day automation trial (funnel signups) or start on the free plan with limited videos. No credit card required where we advertise that. The full pipeline runs — AI quote writing, video render, music, MP4 export. You see exactly what paid users get, at trial or free-tier limits." },
