    ...
    <div className="container mx-auto px-3 sm:px-4 text-center md:px-8">
      ...
      <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
        {niches.map((n) => (
          <div
            key={n.label}
            className="rounded-full border border-primary/20 bg-secondary px-3 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm font-medium text-foreground transition-all hover:border-primary hover:bg-primary/10 hover:shadow-[0_0_20px_hsl(39_76%_52%/0.15)]"
          >
            {n.icon} {n.label}
          </div>
        ))}
