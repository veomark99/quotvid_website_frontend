...
const sections = [
  {
    ...
    content: `QuotVid ("we", "our", "us") operates the website quotvid.com and the web application at app.quotvid.com. This Privacy Policy explains how we collect, use, store, and protect your personal information when you use our services.\n\nBy using QuotVid, you agree to the collection and use of information in accordance with this policy.`,
  },
  {
  ...
  },
  {
    ...
    content: `Your data is stored on secure servers hosted by Railway. We implement industry-standard security measures including:\n- Encrypted connections (HTTPS/TLS)\n- Hashed password storage (bcrypt)\n- JWT-based authentication with expiry\n- Regular security reviews`,
  },
  {
    title: "6. Data Retention",
    content: `We retain your account data for as long as your account is active. If you delete your account, your personal data is deleted within 30 days, except where retention is required by law.\n\nGenerated videos stored on our servers are deleted after 90 days. Downloaded videos you have saved locally are yours to keep.`,
  },
  {
    title: "7. Your Rights",
  ...
  {
    title: "8. Cookies",
    content: `QuotVid uses essential cookies only:\n- Authentication session cookies (required for login)\n- Security tokens\n\nWe do not use advertising cookies or third-party tracking cookies.`,
  },
  {
    title: "9. Children's Privacy",
    content: `QuotVid is not intended for users under the age of 16. We do not knowingly collect personal data from children. If you believe a child has provided us with personal data, contact us immediately.`,
  },
  {
