        ...
        __html: JSON.stringify({
          ...
          "@graph": [
            ...
            },
            {
              ...
              operatingSystem: "Web",
              description:
                "AI quote video studio for TikTok, Instagram Reels, and YouTube Shorts. Two persona modes, Custom Studio with live phone preview, YouTube background picker, background library, accent colors, font size control, 25 languages with RTL support, 20 categories, 17 templates, and cloud video storage.",
              url: "https://www.quotvid.com",
              ...
              featureList: [
                ...
                "17 Animation Templates with Category Matching",
                "1080×1920 Vertical Format for TikTok, Reels, Shorts",
                "25 Language Support with Full RTL Rendering",
              ...
              offers: {
                ...
                offerCount: 4,
                offers: [
                  { "@type": "Offer", name: "Free", price: "0", priceCurrency: "USD", description: "5 videos total, watermark on all videos, AI Persona mode, 20 categories, 17 templates, 25 languages" },
                  { "@type": "Offer", name: "Monthly", price: "20", priceCurrency: "USD", billingIncrement: "month", description: "20 videos per day, no watermark, Custom Studio with live preview, YouTube backgrounds, background library, accent colors, font size control, custom audio upload" },
                  { "@type": "Offer", name: "Annual", price: "149", priceCurrency: "USD", billingIncrement: "year", description: "Everything in Monthly plus priority support" },
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          name: "QuotVid",
          description:
            "AI quote video studio for TikTok, Instagram Reels, and YouTube Shorts. Two persona modes, live phone preview, YouTube background picker, 25 languages, 20 categories, 17 templates, accent colors, background library, and cloud storage.",
          url: "https://www.quotvid.com",
          ...
          offers: [
            {
              ...
              description: "5 videos free, no credit card required, forever. 20 categories, 17 templates, 25 languages.",
            },
            {
              "@type": "Offer",
              ...
              description: "20 videos per day, no watermark, Custom Studio with live preview, YouTube backgrounds, background library, accent colors, font size control, custom audio upload. Billed monthly.",
            },
            {
              "@type": "Offer",
              name: "QuotVid Annual",
              ...
              description: "Everything in Monthly plus priority support. Billed annually. Save $91 vs monthly.",
            },
            {
              "@type": "Offer",
