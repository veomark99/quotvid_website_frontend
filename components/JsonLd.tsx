          ...
          "@graph": [
            ...
            },
            {
              ...
              featureList: [
                ...
                "10+ Video Styles with Category Matching",
              ...
              offers: {
                ...
                offers: [
                  ...
                  { "@type": "Offer", name: "Monthly", price: "10", priceCurrency: "USD", billingIncrement: "month", description: "Unlimited videos per day, no watermark, Custom Studio with live preview, YouTube backgrounds, background library, accent colors, font size control, custom audio upload" },
                  { "@type": "Offer", name: "Annual", price: "99", priceCurrency: "USD", billingIncrement: "year", description: "Everything in Monthly plus priority support. Saves about 17% vs 12 months at $10/mo ($99 vs $120)." },
