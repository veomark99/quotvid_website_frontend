            ...
            },
            {
              ...
              offers: {
                ...
                offers: [
                  ...
                  { "@type": "Offer", name: "Monthly", price: "9.99", priceCurrency: "USD", billingIncrement: "month", description: "Unlimited videos per day, no watermark, Custom Studio with live preview, YouTube backgrounds, background library, accent colors, auto-posting to 5 platforms, custom audio upload" },
                  { "@type": "Offer", name: "Annual", price: "79.99", priceCurrency: "USD", billingIncrement: "year", description: "Everything in Monthly plus priority support." },
                  { "@type": "Offer", name: "Lifetime", price: "199", priceCurrency: "USD", description: "One-time payment, all features forever, no recurring charges" },
                ],
              },
            },
          ],
  ...
  const faqs = [
    {
      ...
      a: "QuotVid creates vertical 1080×1920 quote videos (the standard for TikTok, Instagram Reels, and YouTube Shorts). Each video includes an AI-written quote, professional typography, background music, and your chosen visual template.",
    },
    {
      q: "How many videos do I get?",
      a: "Free plan users get 5 videos total (no credit card, no time limit). Paid plan users (Monthly, Annual, Lifetime) get unlimited videos per day.",
    },
    {
    ...
    },
    {
      ...
      a: "Paste any YouTube URL into the Custom Studio. The video loads in the studio: watch it, pick your favourite 30-second clip, and QuotVid uses it as your background automatically. No downloading required.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes. You get 5 videos completely free, no credit card, no time limit. You see what QuotVid produces for your niche before you pay.",
    },
    {
